  ...
  <body class="bg-zinc-100">
    ...
    <main class="max-w-[1180px] mx-auto px-4 my-16">
      <section class="flex flex-col items-center justify-center">
        <h1 class="text-4xl text-zinc-800 font-bold">Alterar imóveis</h1>
        <p
          class="text-center max-w-sm font-lg leading-relaxed text-zinc-500 mt-4 mb-11"
        >
          Selecione o imóvel que deseja alterar
        </p>
      </section>
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            echo "<a class='flex-1 shadow' href='admin-alterar-dados.php?id={$row['id']}'>";
